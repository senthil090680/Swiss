...
$isrl_id	=	base64_decode($isrl_id);


if($_POST) {

	$queryInsert	=	"INSERT INTO ".TABLE_TOUR_ENQUIRY." (user_name,user_email,user_phone,user_msg,isrl_id,insertedDate) VALUES ('$user_name','$user_email','$user_phone','$user_msg','$isrl_id',NOW())";
	...
	$selectCount	=	"SELECT * FROM ".TABLE_ISRL." WHERE isrl_id = '$isrl_id'";
...
<tr>
 ...
 <tr>
  ...
  <tr>
	...
	$argSubject				=	"Looking for this Israel package details - ". $isrl_name;
	$argMessage				=	$mail_content;


	$argUserSubject				=	"Israel Package Details Enquiry  - ". $isrl_name;
	$argUserMessage				=	"You will be contacted regarding this Israel Package Details - $isrl_name Soon "; 
	...
	$argToEmailAddress				=	'info@swisstravels.ch';  // FOR LIVE
	//$argToEmailAddress			=	$user_email;             // FOR TESTING
	...
	$selectCount	=	"SELECT * from ".TABLE_ISRL." WHERE isrl_status = '1' AND isrl_id = '$isrl_id'";
			$selectResult	=	mysql_query($selectCount) or die (mysql_error());
			$num			=	mysql_num_rows($selectResult);	
			if($num > 0 ) {
				$front_order	=	1;
...
<link href="css/popup_open.css" rel="stylesheet" type="text/css" />
  ...
  <tr>
    <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" valign="top" class="txt">&nbsp;</td>
        <td height="30" align="left" valign="top" class="insidetxt"><?php echo $isrl_name; ?></td>
        <td align="left" valign="top" class="txt">&nbsp;</td>
      </tr>
      <tr>
        ...
        <td width="98%" align="left" valign="top" class="txt"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center" valign="middle"><a href="javascript:void(0);" onclick="beforeCreateChatBox('<?php echo 'controlend/'.$isrl_path; ?>','1')"><img src="<?php echo 'controlend/'.$isrl_path; ?>" width="240" height="180" /></a></td>
            <td align="center" valign="middle"><a href="javascript:void(0);" onclick="beforeCreateChatBox('<?php echo 'controlend/'.$isrl_path1; ?>','2')"><img src="<?php echo 'controlend/'.$isrl_path1; ?>" width="240" height="180" /></a></td>
            <td align="center" valign="middle"><a href="javascript:void(0);" onclick="beforeCreateChatBox('<?php echo 'controlend/'.$isrl_path2; ?>','3')"><img src="<?php echo 'controlend/'.$isrl_path2; ?>" width="240" height="180" /></a></td>
          </tr>
        </table></td>
        <td width="1%" align="left" valign="top" class="txt">&nbsp;</td>
      </tr>
      ...
      <tr>
        ...
        <td align="left" valign="top" class="txt"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100%" align="left" valign="top"><h3 align="justify" class="suptitxt"><?php echo $isrl_name; ?></h3>
              <div align="justify"> 
                  <span class="rtxtr">Package highlights </span>
                  <p>
                    <?php echo $isrl_desc; ?>
                  </p>
                <p><?php echo $isrl_ps; ?></p>
                <p class="suptitxt">Rates applicable for<br />
                      <br />
                  Per Couple <br />
                  <span class="rtxtr"><?php echo $isrl_cost; ?></span>                </p>
                <table width="646">
                    <tbody>
                      <tr>
      ...
      <tr>
        ...
        <td align="left" valign="top" class="txt"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<form name="userinfo" method="post" action="" onsubmit="return vali_isrl_submit();">
