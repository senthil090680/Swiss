...
function plan_sri_submit() {
	var kindtrip				=	document.getElementById('kindtrip');
	var deptdate				=	document.getElementById('deptdate');
	var retdate					=	document.getElementById('retdate');
	var traflex					=	document.getElementById('traflex');
	var preair					=	document.getElementById('preair');
	...
	if(kindtrip.value == '') {
		alert("Please choose the Kind of Trip");
		kindtrip.focus();
		return false;
	}
	if(deptdate.value == '') {
		...
		alert("Please enter the same email as previous");
		re_user_email.focus();
		return false;
	}	
	/*else if(adultpas.value == '') {
...
function showVisitOrder(visitvalue) {
	if(visitvalue == 1) {	
		document.getElementById('visithead').style.display	=	'block';
		...
		document.getElementById('day9').style.display		=	'none';
		document.getElementById('day10').style.display		=	'none';
		document.getElementById('day11').style.display		=	'none';
		document.getElementById('day12').style.display		=	'none';
		document.getElementById('day13').style.display		=	'none';
		document.getElementById('day14').style.display		=	'none';
		document.getElementById('day15').style.display		=	'none';
		document.getElementById('day16').style.display		=	'none';
		...
		document.getElementById('visit2').style.display		=	'block';
		document.getElementById('visit3').style.display		=	'none';
		document.getElementById('visit4').style.display		=	'none';
		document.getElementById('visit5').style.display		=	'none';
		document.getElementById('visit6').style.display		=	'none';
		document.getElementById('visit7').style.display		=	'none';
		document.getElementById('visit8').style.display		=	'none';
		document.getElementById('visit9').style.display		=	'none';
		document.getElementById('visit10').style.display	=	'none';
		document.getElementById('visit11').style.display	=	'none';
		document.getElementById('visit12').style.display	=	'none';
		document.getElementById('visit13').style.display	=	'none';
		document.getElementById('visit14').style.display	=	'none';
		document.getElementById('visit15').style.display	=	'none';
		document.getElementById('visit16').style.display	=	'none';
		...
		document.getElementById('visit2').style.display		=	'block';
		document.getElementById('visit3').style.display		=	'block';
		document.getElementById('visit4').style.display		=	'none';
		document.getElementById('visit5').style.display		=	'none';
		document.getElementById('visit6').style.display		=	'none';
		document.getElementById('visit7').style.display		=	'none';
		...
		document.getElementById('visit2').style.display		=	'block';
		document.getElementById('visit3').style.display		=	'block';
		document.getElementById('visit4').style.display		=	'block';
		document.getElementById('visit5').style.display		=	'none';
		document.getElementById('visit6').style.display		=	'none';
		document.getElementById('visit7').style.display		=	'none';
		document.getElementById('visit8').style.display		=	'none';
		...
		document.getElementById('visit3').style.display		=	'block';
		document.getElementById('visit4').style.display		=	'block';
		document.getElementById('visit5').style.display		=	'block';
		document.getElementById('visit6').style.display		=	'none';
		document.getElementById('visit7').style.display		=	'none';
		document.getElementById('visit8').style.display		=	'none';
		document.getElementById('visit9').style.display		=	'none';
		...
		document.getElementById('visit4').style.display		=	'block';
		document.getElementById('visit5').style.display		=	'block';
		document.getElementById('visit6').style.display		=	'block';
		document.getElementById('visit7').style.display		=	'none';
		document.getElementById('visit8').style.display		=	'none';
		document.getElementById('visit9').style.display		=	'none';
		document.getElementById('visit10').style.display	=	'none';
		...
		document.getElementById('day5').style.display		=	'block';
		document.getElementById('day6').style.display		=	'block';
		document.getElementById('day7').style.display		=	'block';
		document.getElementById('day8').style.display		=	'none';
		document.getElementById('day9').style.display		=	'none';
		document.getElementById('day10').style.display		=	'none';
		document.getElementById('day11').style.display		=	'none';
		...
		document.getElementById('visit5').style.display		=	'block';
		document.getElementById('visit6').style.display		=	'block';
		document.getElementById('visit7').style.display		=	'block';
		document.getElementById('visit8').style.display		=	'none';
		document.getElementById('visit9').style.display		=	'none';
		document.getElementById('visit10').style.display	=	'none';
		document.getElementById('visit11').style.display	=	'none';
		...
		document.getElementById('visit6').style.display		=	'block';
		document.getElementById('visit7').style.display		=	'block';
		document.getElementById('visit8').style.display		=	'block';
		document.getElementById('visit9').style.display		=	'none';
		document.getElementById('visit10').style.display	=	'none';
		document.getElementById('visit11').style.display	=	'none';
		document.getElementById('visit12').style.display	=	'none';
		...
		document.getElementById('day7').style.display		=	'block';
		document.getElementById('day8').style.display		=	'block';
		document.getElementById('day9').style.display		=	'block';
		document.getElementById('day10').style.display		=	'none';
		document.getElementById('day11').style.display		=	'none';
		document.getElementById('day12').style.display		=	'none';
		document.getElementById('day13').style.display		=	'none';
		...
		document.getElementById('visit7').style.display		=	'block';
		document.getElementById('visit8').style.display		=	'block';
		document.getElementById('visit9').style.display		=	'block';
		document.getElementById('visit10').style.display	=	'none';
		document.getElementById('visit11').style.display	=	'none';
		document.getElementById('visit12').style.display	=	'none';
		document.getElementById('visit13').style.display	=	'none';
		...
		document.getElementById('day8').style.display		=	'block';
		document.getElementById('day9').style.display		=	'block';
		document.getElementById('day10').style.display		=	'block';
		document.getElementById('day11').style.display		=	'none';
		document.getElementById('day12').style.display		=	'none';
		document.getElementById('day13').style.display		=	'none';
		document.getElementById('day14').style.display		=	'none';
		...
		document.getElementById('visit8').style.display		=	'block';
		document.getElementById('visit9').style.display		=	'block';
		document.getElementById('visit10').style.display	=	'block';
		document.getElementById('visit11').style.display	=	'none';
		document.getElementById('visit12').style.display	=	'none';
		document.getElementById('visit13').style.display	=	'none';
		document.getElementById('visit14').style.display	=	'none';
		...
		document.getElementById('visit9').style.display		=	'block';
		document.getElementById('visit10').style.display	=	'block';
		document.getElementById('visit11').style.display	=	'block';
		document.getElementById('visit12').style.display	=	'none';
		document.getElementById('visit13').style.display	=	'none';
		document.getElementById('visit14').style.display	=	'none';
		document.getElementById('visit15').style.display	=	'none';
		document.getElementById('visit16').style.display	=	'none';
	} else if(visitvalue == 12) {	
		document.getElementById('visithead').style.display	=	'block';
		document.getElementById('day1').style.display		=	'block';
		document.getElementById('day2').style.display		=	'block';
		document.getElementById('day3').style.display		=	'block';
		...
		document.getElementById('day10').style.display		=	'block';
		document.getElementById('day11').style.display		=	'block';
		document.getElementById('day12').style.display		=	'block';
		document.getElementById('day13').style.display		=	'none';
		document.getElementById('day14').style.display		=	'none';
		document.getElementById('day15').style.display		=	'none';
		document.getElementById('day16').style.display		=	'none';
		...
		document.getElementById('visit10').style.display	=	'block';
		document.getElementById('visit11').style.display	=	'block';
		document.getElementById('visit12').style.display	=	'block';
		document.getElementById('visit13').style.display	=	'none';
		document.getElementById('visit14').style.display	=	'none';
		document.getElementById('visit15').style.display	=	'none';
		document.getElementById('visit16').style.display	=	'none';
	} else if(visitvalue == 13) {	
		document.getElementById('visithead').style.display	=	'block';
		document.getElementById('day1').style.display		=	'block';
		document.getElementById('day2').style.display		=	'block';
		document.getElementById('day3').style.display		=	'block';
		...
		document.getElementById('day11').style.display		=	'block';
		document.getElementById('day12').style.display		=	'block';
		document.getElementById('day13').style.display		=	'block';
		document.getElementById('day14').style.display		=	'none';
		document.getElementById('day15').style.display		=	'none';
		document.getElementById('day16').style.display		=	'none';
		...
		document.getElementById('visit11').style.display	=	'block';
		document.getElementById('visit12').style.display	=	'block';
		document.getElementById('visit13').style.display	=	'block';
		document.getElementById('visit14').style.display	=	'none';
		document.getElementById('visit15').style.display	=	'none';
		document.getElementById('visit16').style.display	=	'none';
	} else if(visitvalue == 14) {	
		document.getElementById('visithead').style.display	=	'block';
		document.getElementById('day1').style.display		=	'block';
		document.getElementById('day2').style.display		=	'block';
		document.getElementById('day3').style.display		=	'block';
		...
		document.getElementById('visit12').style.display	=	'block';
		document.getElementById('visit13').style.display	=	'block';
		document.getElementById('visit14').style.display	=	'block';
		document.getElementById('visit15').style.display	=	'none';
		document.getElementById('visit16').style.display	=	'none';
	} else if(visitvalue == 15) {	
		document.getElementById('visithead').style.display	=	'block';
		document.getElementById('day1').style.display		=	'block';
		document.getElementById('day2').style.display		=	'block';
		document.getElementById('day3').style.display		=	'block';
		...
		document.getElementById('day13').style.display		=	'block';
		document.getElementById('day14').style.display		=	'block';
		document.getElementById('day15').style.display		=	'block';
		document.getElementById('day16').style.display		=	'none';
		...
		document.getElementById('visit13').style.display	=	'block';
		document.getElementById('visit14').style.display	=	'block';
		document.getElementById('visit15').style.display	=	'block';
		document.getElementById('visit16').style.display	=	'none';
	} else if(visitvalue == 16) {	
		document.getElementById('visithead').style.display	=	'block';
		document.getElementById('day1').style.display		=	'block';
		document.getElementById('day2').style.display		=	'block';
		document.getElementById('day3').style.display		=	'block';
		...
		document.getElementById('day14').style.display		=	'block';
		document.getElementById('day15').style.display		=	'block';
		document.getElementById('day16').style.display		=	'block';
		...
		document.getElementById('visit14').style.display	=	'block';
		document.getElementById('visit15').style.display	=	'block';
		document.getElementById('visit16').style.display	=	'block';
	} else if(visitvalue == '') {	
		document.getElementById('visithead').style.display	=	'none';
		...
		document.getElementById('visit2').style.display		=	'none';
		document.getElementById('visit3').style.display		=	'none';
		document.getElementById('visit4').style.display		=	'none';
		document.getElementById('visit5').style.display		=	'none';
		document.getElementById('visit6').style.display		=	'none';
...
function showkindtour(kindvalue) {
   if(kindvalue == '') {
        alert("Please select valid Kind of Tour");       
   } else {
        ...
        xmlhttp.open("GET","showkindtour.php?kindtour="+kindvalue,true);
        xmlhttp.send(null);       
   }
}


function vali_fli_submit() {
	var deptdate			=	document.getElementById('deptdate');
	var retdate				=	document.getElementById('retdate');
	var traflex				=	document.getElementById('traflex');
	var preair				=	document.getElementById('preair');
