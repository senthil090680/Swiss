...
&nbsp;<img src="images/cal.gif" onclick="javascript:NewCssCal ('retdate','ddMMyyyy')"/></td>
            ...
            <tr id="pas1" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Mr / Mrs : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="pas1cre" id="pas1cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.' >Mrs.</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="pas1name" id="pas1name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="pas2" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Mr / Mrs : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="pas2cre" id="pas2cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="pas2name" id="pas2name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="pas3" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Mr / Mrs : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="pas3cre" id="pas3cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="pas3name" id="pas3name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="pas4" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Mr / Mrs : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="pas4cre" id="pas4cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="pas4name" id="pas4name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="pas5" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Mr / Mrs : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="pas5cre" id="pas5cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="pas5name" id="pas5name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="25" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="chi1" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Master / Miss : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="chi1cre" id="chi1cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Master'>Master</option>
                    <option value='Miss' >Miss</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="chi1name" id="chi1name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="chi2" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Master / Miss : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="chi2cre" id="chi2cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Master'>Master</option>
                    <option value='Miss'>Miss</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="chi2name" id="chi2name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="chi3" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Master / Miss : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="chi3cre" id="chi3cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Master'>Master</option>
                    <option value='Miss'>Miss</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="chi3name" id="chi3name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="chi4" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Master / Miss : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="chi4cre" id="chi4cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Master'>Master</option>
                    <option value='Miss'>Miss</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="chi4name" id="chi4name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="25" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="chi5" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Master / Miss : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="chi5cre" id="chi5cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Master'>Master</option>
                    <option value='Miss'>Miss</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="chi5name" id="chi5name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="25" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="inf1" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Baby Boy / Girl : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="inf1cre" id="inf1cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Baby Boy'>Baby Boy</option>
                    <option value='Baby Girl' >Baby Girl</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="inf1name" id="inf1name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="inf2" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Baby Boy / Girl : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="inf2cre" id="inf2cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Baby Boy'>Baby Boy</option>
                    <option value='Baby Girl'>Baby Girl</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="inf2name" id="inf2name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="inf3" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Baby Boy / Girl : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="inf3cre" id="inf3cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Baby Boy'>Baby Boy</option>
                    <option value='Baby Girl'>Baby Girl</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="inf3name" id="inf3name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="inf4" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="25%" align="left" valign="middle" class="txt" nowrap="nowrap">Baby Boy / Girl : </td>
                  <td width="24%" height="25" align="left" valign="middle" class="txt" nowrap="nowrap"><select name="inf4cre" id="inf4cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Baby Boy'>Baby Boy</option>
                    <option value='Baby Girl'>Baby Girl</option>
                  </select></td>
                  <td width="26%" align="left" valign="middle"class="txt" nowrap="nowrap">Name : </td>
                  <td width="25%" align="left" valign="middle"class="txt" nowrap="nowrap"><input type="text" name="inf4name" id="inf4name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="25" align="left" valign="middle">&nbsp;</td>
