<?php
	...
	define('ROOT_DIRECTORY', 'swiss/controlend');
    ...
    define('TABLE_ISRL', 'isrl_plan');						//ISRAEL TOUR TABLE NAME        
	define('TABLE_DAY', 'sri_days');						//SRILANKA TOUR TABLE NAME
	define('TABLE_COUNTRY', 'country_list');				//COUNTRY TABLE NAME
    ...
    define('ISRL_PATH_INFO', 'isrl_path/');
	define('ISRL_PATH_INFO1', 'isrl_path1/');
	define('ISRL_PATH_INFO2', 'isrl_path2/');
	...
	define('DAY4A_PATH1', 'day4a_path1/');
	define('DAY4A_PATH2', 'day4a_path2/');
	define('DAY4A_PATH3', 'day4a_path3/');
	define('DAY4A_PATH4', 'day4a_path4/');
    ...
    define('DAY13_PATH1', 'day13_path1/');
	define('DAY13_PATH2', 'day13_path2/');
	define('DAY13_PATH3', 'day13_path3/');
	define('DAY13_PATH4', 'day13_path4/');
        
    define('DAY14_PATH1', 'day14_path1/');
	define('DAY14_PATH2', 'day14_path2/');
	define('DAY14_PATH3', 'day14_path3/');
	define('DAY14_PATH4', 'day14_path4/');
