			...
			<tr>	
				...
				<?php $conWhere		=	" WHERE flight_status = '1' AND continent_name = 'ASI' LIMIT 5";
				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                    ...
                    <td width="60%" align="left" valign="top" >&nbsp;&nbsp;&nbsp;<a class="rtxtr" href='javascript:void(0);' onclick="callingpage('<?php echo $pathVal[flight_id]; ?>');"><?php echo $pathVal[flight_cost]; ?></a></td>
					</tr></table>
