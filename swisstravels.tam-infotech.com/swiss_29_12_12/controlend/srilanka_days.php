...
if($_REQUEST) {
	...
	if(isset($_REQUEST['action']) && $_REQUEST['action'] != '' ) {
		...
		if($_POST['action'] == 'edit') {
			...
			if($_FILES['day2_path3']['error']>0)
			{
				echo $_FILES['day2_path3']['error']; die($_FILES['day2_path3']['error']);
			}
			else
			{
				$day2_path3_name=$_FILES['day2_path3']['name'];
			...
			if($_FILES['day2_path4']['error']>0)
			{
				echo $_FILES['day2_path4']['error']; die($_FILES['day2_path4']['error']);
			}
			else
			{
				$day2_path4_name=$_FILES['day2_path4']['name'];
			...
			if($_FILES['day3_path1']['error']>0)
			{
				echo $_FILES['day3_path1']['error']; die($_FILES['day3_path1']['error']);
			}
			else
			{
				$day3_path1_name=$_FILES['day3_path1']['name'];
			...
			if($_FILES['day3_path2']['error']>0)
			{
				echo $_FILES['day3_path2']['error']; die($_FILES['day3_path2']['error']);
			}
			else
			{
				$day3_path2_name=$_FILES['day3_path2']['name'];
			...
			if($_FILES['day3_path3']['error']>0)
			{
				echo $_FILES['day3_path3']['error']; die($_FILES['day3_path3']['error']);
			}
			else
			{
				$day3_path3_name=$_FILES['day3_path3']['name'];
			...
			if($_FILES['day3_path4']['error']>0)
			{
				echo $_FILES['day3_path4']['error']; die($_FILES['day3_path4']['error']);
			}
			else
			{
				$day3_path4_name=$_FILES['day3_path4']['name'];
			...
			if($_FILES['day4_path1']['error']>0)
			{
				echo $_FILES['day4_path1']['error']; die($_FILES['day4_path1']['error']);
			}
			else
			{
				$day4_path1_name=$_FILES['day4_path1']['name'];
			...
			if($_FILES['day4_path2']['error']>0)
			{
				echo $_FILES['day4_path2']['error']; die($_FILES['day4_path2']['error']);
			}
			else
			{
				$day4_path2_name=$_FILES['day4_path2']['name'];
			...
			if($_FILES['day4_path3']['error']>0)
			{
				echo $_FILES['day4_path3']['error']; die($_FILES['day4_path3']['error']);
			}
			else
			{
				$day4_path3_name=$_FILES['day4_path3']['name'];
			...
			if($_FILES['day4_path4']['error']>0)
			{
				echo $_FILES['day4_path4']['error']; die($_FILES['day4_path4']['error']);
			}
			else
			{
				$day4_path4_name=$_FILES['day4_path4']['name'];
			...
			if($_FILES['day5_path1']['error']>0)
			{
				echo $_FILES['day5_path1']['error']; die($_FILES['day5_path1']['error']);
			}
			else
			{
				$day5_path1_name=$_FILES['day5_path1']['name'];
			...
			if($_FILES['day5_path2']['error']>0)
			{
				echo $_FILES['day5_path2']['error']; die($_FILES['day5_path2']['error']);
			}
			else
			{
				$day5_path2_name=$_FILES['day5_path2']['name'];
			...
			if($_FILES['day5_path3']['error']>0)
			{
				echo $_FILES['day5_path3']['error']; die($_FILES['day5_path3']['error']);
			}
			else
			{
				$day5_path3_name=$_FILES['day5_path3']['name'];
			...
			if($_FILES['day5_path4']['error']>0)
			{
				echo $_FILES['day5_path4']['error']; die($_FILES['day5_path4']['error']);
			}
			else
			{
				$day5_path4_name=$_FILES['day5_path4']['name'];
			...
			if($_FILES['day6_path1']['error']>0)
			{
				echo $_FILES['day6_path1']['error']; die($_FILES['day6_path1']['error']);
			}
			else
			{
				$day6_path1_name=$_FILES['day6_path1']['name'];
			...
			if($_FILES['day6_path2']['error']>0)
			{
				echo $_FILES['day6_path2']['error']; die($_FILES['day6_path2']['error']);
			}
			else
			{
				$day6_path2_name=$_FILES['day6_path2']['name'];
			...
			if($_FILES['day6_path3']['error']>0)
			{
				echo $_FILES['day6_path3']['error']; die($_FILES['day6_path3']['error']);
			}
			else
			{
				$day6_path3_name=$_FILES['day6_path3']['name'];
			...
			if($_FILES['day6_path4']['error']>0)
			{
				echo $_FILES['day6_path4']['error']; die($_FILES['day6_path4']['error']);
			}
			else
			{
				$day6_path4_name=$_FILES['day6_path4']['name'];
			...
			if($_FILES['day7_path1']['error']>0)
			{
				echo $_FILES['day7_path1']['error']; die($_FILES['day7_path1']['error']);
			}
			else
			{
				$day7_path1_name=$_FILES['day7_path1']['name'];
			...
			if($_FILES['day7_path2']['error']>0)
			{
				echo $_FILES['day7_path2']['error']; die($_FILES['day7_path2']['error']);
			}
			else
			{
				$day7_path2_name=$_FILES['day7_path2']['name'];
			...
			if($_FILES['day7_path3']['error']>0)
			{
				echo $_FILES['day7_path3']['error']; die($_FILES['day7_path3']['error']);
			}
			else
			{
				$day7_path3_name=$_FILES['day7_path3']['name'];
			...
			if($_FILES['day7_path4']['error']>0)
			{
				echo $_FILES['day7_path4']['error']; die($_FILES['day7_path4']['error']);
			}
			else
			{
				$day7_path4_name=$_FILES['day7_path4']['name'];
			...
			if($_FILES['day8_path1']['error']>0)
			{
				echo $_FILES['day8_path1']['error']; die($_FILES['day8_path1']['error']);
			}
			else
			{
				$day8_path1_name=$_FILES['day8_path1']['name'];
			...
			if($_FILES['day8_path2']['error']>0)
			{
				echo $_FILES['day8_path2']['error']; die($_FILES['day8_path2']['error']);
			}
			else
			{
				$day8_path2_name=$_FILES['day8_path2']['name'];
			...
			if($_FILES['day8_path3']['error']>0)
			{
				echo $_FILES['day8_path3']['error']; die($_FILES['day8_path3']['error']);
			}
			else
			{
				$day8_path3_name=$_FILES['day8_path3']['name'];
			...
			if($_FILES['day8_path4']['error']>0)
			{
				echo $_FILES['day8_path4']['error']; die($_FILES['day8_path4']['error']);
			}
			else
			{
				$day8_path4_name=$_FILES['day8_path4']['name'];
			...
			if($_FILES['day9_path1']['error']>0)
			{
				echo $_FILES['day9_path1']['error']; die($_FILES['day9_path1']['error']);
			}
			else
			{
				$day9_path1_name=$_FILES['day9_path1']['name'];
			...
			if($_FILES['day9_path2']['error']>0)
			{
				echo $_FILES['day9_path2']['error']; die($_FILES['day9_path2']['error']);
			}
			else
			{
				$day9_path2_name=$_FILES['day9_path2']['name'];
			...
			if($_FILES['day9_path3']['error']>0)
			{
				echo $_FILES['day9_path3']['error']; die($_FILES['day9_path3']['error']);
			}
			else
			{
				$day9_path3_name=$_FILES['day9_path3']['name'];
			...
			if($_FILES['day9_path4']['error']>0)
			{
				echo $_FILES['day9_path4']['error']; die($_FILES['day9_path4']['error']);
			}
			else
			{
				$day9_path4_name=$_FILES['day9_path4']['name'];
			...
			if($_FILES['day10_path1']['error']>0)
			{
				echo $_FILES['day10_path1']['error']; die($_FILES['day10_path1']['error']);
			}
			else
			{
				$day10_path1_name=$_FILES['day10_path1']['name'];
			...
			if($_FILES['day10_path2']['error']>0)
			{
				echo $_FILES['day10_path2']['error']; die($_FILES['day10_path2']['error']);
			}
			else
			{
				$day10_path2_name=$_FILES['day10_path2']['name'];
			...
			if($_FILES['day10_path3']['error']>0)
			{
				echo $_FILES['day10_path3']['error']; die($_FILES['day10_path3']['error']);
			}
			else
			{
				$day10_path3_name=$_FILES['day10_path3']['name'];
			...
			if($_FILES['day10_path4']['error']>0)
			{
				echo $_FILES['day10_path4']['error']; die($_FILES['day10_path4']['error']);
			}
			else
			{
				$day10_path4_name=$_FILES['day10_path4']['name'];
			...
			if($_FILES['day11_path1']['error']>0)
			{
				echo $_FILES['day11_path1']['error']; die($_FILES['day11_path1']['error']);
			}
			else
			{
				$day11_path1_name=$_FILES['day11_path1']['name'];
			...
			if($_FILES['day11_path2']['error']>0)
			{
				echo $_FILES['day11_path2']['error']; die($_FILES['day11_path2']['error']);
			}
			else
			{
				$day11_path2_name=$_FILES['day11_path2']['name'];
			...
			if($_FILES['day11_path3']['error']>0)
			{
				echo $_FILES['day11_path3']['error']; die($_FILES['day11_path3']['error']);
			}
			else
			{
				$day11_path3_name=$_FILES['day11_path3']['name'];
			...
			if($_FILES['day11_path4']['error']>0)
			{
				echo $_FILES['day11_path4']['error']; die($_FILES['day11_path4']['error']);
			}
			else
			{
				$day11_path4_name=$_FILES['day11_path4']['name'];
...
<script type="text/javascript">
	...
	function editDay(day_id,sri_id,day_name,day1_title,day2_title,day2_place,day2_desc,day2_path1,day2_path2,day2_path3,day2_path4,day2_stay,day3_title,day3_place,day3_desc,day3_path1,day3_path2,day3_path3,day3_path4,day3_stay,day4_title,day4_place,day4_desc,day4_path1,day4_path2,day4_path3,day4_path4,day4_stay,day5_title,day5_place,day5_desc,day5_path1,day5_path2,day5_path3,day5_path4,  day5_stay,day6_title,day6_place,day6_desc,day6_path1,day6_path2,day6_path3,day6_path4,day6_stay,day7_title,day7_place,day7_desc,day7_path1,day7_path2,day7_path3,day7_path4,day7_stay,day8_title,day8_place,day8_desc,day8_path1,day8_path2,day8_path3,day8_path4,day8_stay,day9_title,day9_place,day9_desc,day9_path1,day9_path2,day9_path3,day9_path4,day9_stay,day10_title,day10_place,day10_desc,day10_path1,day10_path2,day10_path3,day10_path4,day10_stay,day11_title,day11_place,day11_desc,day11_path1,day11_path2,day11_path3,day11_path4,day11_stay,day12_title,price_include,price_notinclude,day_status,day_insertedDate){
		d												=	document.day_form;
...
<tr>
	<td>
		<table class="tablecss" border='1'>
			...
			$result = SingleTon::selectQuery("day_id,sri_id,day_name,day1_title,day2_title,day2_place,day2_desc,day2_path1,day2_path2,day2_path3,day2_path4,day2_stay,day3_title,day3_place,day3_desc,day3_path1,day3_path2,day3_path3,day3_path4,day3_stay,day4_title,day4_place,day4_desc,day4_path1,day4_path2,day4_path3,day4_path4,day4_stay,day5_title,day5_place,day5_desc,day5_path1,day5_path2,day5_path3,day5_path4,  day5_stay,day6_title,day6_place,day6_desc,day6_path1,day6_path2,day6_path3,day6_path4,day6_stay,day7_title,day7_place,day7_desc,day7_path1,day7_path2,day7_path3,day7_path4,day7_stay,day8_title,day8_place,day8_desc,day8_path1,day8_path2,day8_path3,day8_path4,day8_stay,day9_title,day9_place,day9_desc,day9_path1,day9_path2,day9_path3,day9_path4,day9_stay,day10_title,day10_place,day10_desc,day10_path1,day10_path2,day10_path3,day10_path4,day10_stay,day11_title,day11_place,day11_desc,day11_path1,day11_path2,day11_path3,day11_path4,day11_stay,day12_title,price_include,price_notinclude,day_status","ORDER BY day_id DESC",TABLE_DAY,MY_ASSOC,NOR_YES);
