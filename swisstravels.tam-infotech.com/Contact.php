...
if(isset($_POST['submit'])) {
	...
	$argAdminFromEmailAddress		=	'admin@swisstravels.ch';
	$argToAdminEmailAddress			=	$email;
	$argAdminReplyToEmailAddress	=	'noreply@swisstravels.ch';
	...
	$funheadersAdmin				.= "Return-Path: <admin@swisstravels.ch>\n";
	$funheadersAdmin				.= "Sender: admin@swisstravels.ch\n";
