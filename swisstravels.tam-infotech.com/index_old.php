...
?>
  ...
  <tr>
    ...
    <dl>
	    ...
	    <dt></dt>
	    <dd>
	       <img src="slide/Whychoose.jpg" width="990" height="252" />	    </dd>
	
	    <dt></dt>
	    <dd>
	      <img src="slide/Wegive.jpg" width="990" height="252" />	    </dd>
	
	    <dt></dt>
	    <dd>	        
	        <img src="slide/ourservices.jpg" width="990" height="252" />		    </dd>
	
	    <dt></dt>
	    <dd>        
	       <img src="slide/Training.jpg" width="990" height="252" />    </dd> 
			...
			<tr>	
				...
				<?php $conWhere		=	" WHERE flight_status = '1' AND continent_name = 'ASI' LIMIT 5";
				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0" ><tr>
                    ...
                    <td width="53%" align="left" valign="top" >&nbsp;&nbsp;&nbsp;<a class="rtxtr" href='javascript:void(0);' onclick="callingpage('<?php echo $pathVal[flight_id]; ?>');"><?php echo $pathVal[flight_cost]; ?></a></td>
...
<ul class="thumbnail">
	<?php if($num_rows > 0) {
				...
				foreach($result[1] as $pathVal){ ?>
	<li><a href='javascript:void(0);' onclick="callingpage('<?php echo $pathVal[tour_id]; ?>');"><img src="<?php echo 'controlend/'.$pathVal[thumb_path]; ?>" width="174" height="142" /></a></li>
		<?php }  } ?>
</td>
