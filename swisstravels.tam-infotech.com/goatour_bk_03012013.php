                ...
                <tr>
                  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="middle">Telephone / Mobile : </td>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="middle"><input type="text" name="departure2" id="departure2" size="25" class="input" readonly="readonly" />
                        &nbsp;<img src="images/cal.gif" onclick="javascript:NewCssCal ('departure','ddMMyyyy')"/></td>
                    </tr>
                    <tr>
                      <td height="19" align="left" valign="middle">&nbsp;</td>
                    ...
                    <tr>
                      <td height="25" align="left" valign="middle">Date of arrival</td>
                      <td align="left" valign="middle" nowrap="nowrap" ><input type="text" name="arrival" id="arrival" size="25" class="input" readonly="readonly" />
                        &nbsp;<img src="images/cal.gif" onclick="javascript:NewCssCal ('arrival','ddMMyyyy')"/></td>
                      <td align="left" valign="middle" nowrap="nowrap">Departure airport : </td>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="middle"><input type="text" name="destair" id="destair" size="25" class="input" /></td>
                    ...
                    <tr>
                      <td height="19" align="left" valign="middle">Preferred airline : </td>
