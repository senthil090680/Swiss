...
if($_POST) {
	...
	$addressbr			=	nl2br($address);

	//echo $addressbr			=	str_replace('<br/>', "\n", $address);

	//echo $val = str_replace( array("\r\n", "\n","\r"), '<br />', $address );

	//echo $addressbr = preg_replace( "#\r\n|\n|\r#", '<br />', $address );
...
<tr>
  ...
  <tr>
    <td align='left' valign='middle' nowrap='nowrap'><strong>Children in separate Room : </strong></td>
    <td height='40' align='left' valign='middle'>$chiroom</td>
    <td align='left' valign='middle' nowrap='nowrap'><strong>Requirement of Baby Cot : </strong></td>
    <td align='left' valign='middle'>$babycot</td>
  </tr>

  <tr>
    <td align='left' valign='middle' nowrap='nowrap'><strong>Preferred Tour guide&nbsp;: </strong></td>
    <td height='40' colspan='3' align='left' valign='middle' nowrap='nowrap'>$tourguidestr</td>
  </tr>
  <tr>
  ...
  <tr>
	...
	$argSubject							=	"Looking for My Own Package Details";
	$argMessage							=	$mail_content;


	$argUserSubject						=	"My Own Package Details Enquiry";
	$argUserMessage						=	"You will be contacted regarding your Package Details soon "; 
	...
	if (mail($argToEmailAddress, $argUserSubject, $argUserMessage, $argheaders)) { $funValue = 'yes'; }//if This is to user
	
	$argFromEmailAddress				=	EMAIL_ADMIN_SENDER;
	$argReplyToEmailAddress             =	EMAIL_ADMIN_SENDER;

	//$argToEmailAddress				=	$user_email;					// For testing
    $argToEmailAddress					=	EMAIL_ADMIN_RECEIVER;			// For Live
	...
	if (mail($argToEmailAddress, $argSubject, $argMessage, $argheadersAdmin)) { $funValue = 'yes'; }//if  This is to Admin
?>
        ...
        <td width="99%" align="left" valign="top" class="txt"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="83%" height="76" align="left" valign="top"><div align="justify">
              <p>
                With the below-customized PLAN MY SRI LANKA TOUR form you can plan your Sri Lanka tour according to your interest and budget. Based on the information that you provide in this form our team will send you a no obligation price quote with the tour itinerary. Any time you can make changes in your customized tour itinerary (please note: prices might increase or decrease when changes are made). 
