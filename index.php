...
<script type="text/javascript">
  ...
  <tr>
    <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="2%" height="19" align="left" valign="top">&nbsp;</td>
	...
	<?php	$selectCount	=	"SELECT * from ".TABLE_PLAN." WHERE plan_status = '1' ORDER BY tour_id DESC";
			...
			while($row = mysql_fetch_array($selectResult)) {
				...
				$tour_desc				=		str_ireplace("Price","<span class='formatDesc'>Price",$row['tour_desc']);
				$country_name			=		$row['country_name'];
				$tour_name				=		$row['tour_name'];
				
				$tour_desc				=		str_ireplace("CHF","CHF</span>",$tour_desc);
	 ...
	 <?php if($front_order == 1 || $front_order == 3 || $front_order == 5) { ?>
	  ...
	  <tr>
	    ...
	    <td height="19" align="left" valign="top">&nbsp;</td>
	    <td colspan="2" rowspan="3" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="3" class="homeNorTitle"><?php 
			/*foreach($country_array as $connameKey=>$connameVal) { if($connameKey == $country_name) { echo $connameVal ." - ". $tour_name; } }*/
			
			foreach($country_result[1] as $country_result_value) { if($country_result_value[iso3] == $country_name) { echo $country_result_value[printable_name] ." - ". $tour_name; } }	
			?></td>
            </tr>
          <tr>
            <td width="41%">&nbsp;</td>
          ...
          <tr>
            <td><a href='javascript:void(0);' onclick="callingpage('<?php echo base64_encode($tour_id); ?>');"><img src="<?php echo 'controlend/'.$thumb_path; ?>" width="174" height="142" /></a></td>
	    ...
	    <!-- <td align="left" valign="top">&nbsp;</td> -->
	    <td colspan="3" rowspan="3" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="3" class="homeNorTitle"><?php 
			foreach($country_result[1] as $country_result_value) { if($country_result_value[iso3] == $country_name) { echo $country_result_value[printable_name] ." - ". $tour_name; } }
		
		/*foreach($country_array as $connameKey=>$connameVal) { if($connameKey == $country_name) { echo $connameVal ." - ". $tour_name; } }*/ ?></td>
          </tr>
          <tr>
            <td width="41%">&nbsp;</td>
            <td width="56%">&nbsp;</td>
  ...
  <tr>
    <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		$conWhere		=	" WHERE flight_status = '1' GROUP BY continent_name ORDER BY flight_id DESC LIMIT 3";

		$result			=	SingleTon::selectQuery("continent_name","$conWhere",TABLE_FLIGHT,MY_ASSOC,NOR_YES);
		...
		$FirstContinent		=	$continents[0][continent_name];

		$SecondContinent	=	$continents[1][continent_name];

		$ThirdContinent		=	$continents[2][continent_name];
		...
		?>
			...
			<tr>	
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
				    <td width="35%" align="left" valign="top" class="txt"><strong><?php echo $FirstContinent; ?></strong></td>
				    <td width="34%" height="30" align="left" valign="top" class="txt"><strong><?php echo $SecondContinent; ?></strong></td>
				    <td width="31%" align="left" valign="top" class="txt"><strong><?php echo $ThirdContinent; ?></strong></td>
				    </tr>
				  <tr>
				...
				<?php $conWhere		=	" WHERE flight_status = '1' AND continent_name = '$FirstContinent' LIMIT 8";
				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                    ...
                    <td width="40%" height="27" align="left" valign="top" class="txt"><?php echo $pathVal[country_name]; ?> </td>
					...
					<td valign='top'>	
				  <?php $conWhere		=	" WHERE flight_status = '1' AND continent_name = '$SecondContinent' LIMIT 8";
				  ...
				  <?php $conWhere		=	" WHERE flight_status = '1' AND continent_name = '$ThirdContinent' LIMIT 8";
				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0" ><tr>
                    ...
                    <td width="47%" height="27" align="left" valign="top" class="txt"><?php echo $pathVal[country_name]; ?> </td>
