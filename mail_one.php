...
?>
      ...
      <tr>
        ...
        <td align="left" valign="top" class="txt"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="17%" height="144" align="left" valign="top"><a href="javascript:void(0);" onclick="beforeCreateChatBox('<?php echo 'controlend/'.$sri_path; ?>','1')"><img src="<?php echo 'controlend/'.$sri_path; ?>" width="105" height="104" /></a></td>
                ...
                <tr>
                  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="11%" align="left" valign="top"><a href='javascript:void(0);' onclick="callingsripage('<?php echo base64_encode($sri_id); ?>');"><img src="images/moredetails.jpg" width="80" height="22" border="0" /></a></td>
                      <td width="11%" align="left" valign="top"><a href='javascript:void(0);' onclick="callingsripage('<?php echo base64_encode($sri_id); ?>');"><img src="images/booknow.jpg" width="80" height="22" border="0" /></a></td>                      
                    </tr>
                  </table></td>
                </tr>
              </table>
