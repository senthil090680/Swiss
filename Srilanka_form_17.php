		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" height="30" align="left" valign="middle"><strong>Kind of Trip : </strong></td>
                  <td width="25%" align="left" valign="middle"><select name="kindtrip" id="kindtrip" class="input" style="width:200px">
...
&nbsp;<img src="images/cal.gif" onclick="javascript:NewCssCal ('retdate','ddMMyyyy')"/></td>
            ...
            <tr>
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" height="25" align="left" valign="middle"><strong>Passenger</strong></td>
            ...
            <tr id="pas1" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="pas1cre" id="pas1cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.' >Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="pas1name" id="pas1name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="pas2" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="pas2cre" id="pas2cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="pas2name" id="pas2name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="pas3" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="pas3cre" id="pas3cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="pas3name" id="pas3name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="pas4" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="pas4cre" id="pas4cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="pas4name" id="pas4name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="pas5" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="pas5cre" id="pas5cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="pas5name" id="pas5name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="25" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="chi1" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="chi1cre" id="chi1cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.' >Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="chi1name" id="chi1name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="chi2" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="chi2cre" id="chi2cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="chi2name" id="chi2name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="chi3" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="chi3cre" id="chi3cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="chi3name" id="chi3name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="chi4" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="chi4cre" id="chi4cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="chi4name" id="chi4name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="25" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="chi5" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="chi5cre" id="chi5cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="chi5name" id="chi5name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="25" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="inf1" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="inf1cre" id="inf1cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.' >Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="inf1name" id="inf1name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="inf2" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="inf2cre" id="inf2cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="inf2name" id="inf2name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="inf3" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="inf3cre" id="inf3cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="inf3name" id="inf3name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="19" align="left" valign="middle">&nbsp;</td>
            ...
            <tr id="inf4" class="shownone">
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt">Mr / Mrs : </td>
                  <td width="25%" height="25" align="left" valign="middle" class="txt"><select name="inf4cre" id="inf4cre" class="input" style="width:200px">
                    <option value=''>- select -</option>
                    <option value='Mr.'>Mr.</option>
                    <option value='Mrs.'>Mrs.</option>
                  </select></td>
                  <td width="19%" align="left" valign="middle"class="txt">Name : </td>
                  <td width="37%" align="left" valign="middle"class="txt"><input type="text" name="inf4name" id="inf4name" size="25" class="input" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td height="25" align="left" valign="middle">&nbsp;</td>
            ...
            <tr>
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" align="left" valign="middle" class="txt"><p><strong>Add more passengers</strong></p></td>
                  <td width="30%" height="25" align="left" valign="middle" class="txt"><p><strong>Special Wishes &amp;  rem.</strong></p></td>
                ...
                <tr>
                  <td height="30" colspan="4" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="19%" align="left" valign="middle">No of Days :</td>
                          <td width="18%" align="left" valign="middle" class="txt"><select name="noofdays" id="noofdays" class="input" size:width="200" >
                              <option value=''>- select -</option>
                              <?php for($w=1; $w < 61; $w++) { ?>
                              <option value='<?php echo $w; ?>'><?php echo $w; ?></option>
                              <?php } ?>
                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="19%" height="25" align="left" valign="top" class="txt">Dubai :</td>
                            <td width="30%" height="25" align="left" valign="top" class="txt"><select name="dubaidays" id="dubaidays" class="input" size:width="200" >
                                <option value=''>- select -</option>
								<?php for($w=1; $w < 61; $w++) { ?>
                                <option value='<?php echo $w; ?>'><?php echo $w; ?></option>
								<?php } ?>
                              ...
                              days</td>
                            <td width="27%" height="30" align="left" valign="top"class="txt">If you wish to make a stopover in Dubai</td>
                            <td width="24%" height="30" align="left" valign="top"class="txt">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="left" valign="middle">&nbsp;</td>
                            <td height="19" align="left" valign="middle">&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td height="19" align="left" valign="middle"><select name="maledays" id="maledays" class="input" size:width="200" >
                                <option value=''>- select -</option>
								<?php for($w=1; $w < 61; $w++) { ?>
                                <option value='<?php echo $w; ?>'><?php echo $w; ?></option>
								<?php } ?>
					 ...
					 <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="12%" height="31" align="left" valign="top" class="txt">Land  Based :</td>
                            <td height="31" colspan="3" align="left" valign="top" nowrap="nowrap" class="txt"><input type="checkbox" name="waterbase[]" id="waterbase" value="White Water Rafting"/>White Water Rafting
                            ...
                            <br />
                            <br />
                            <input type="checkbox" name="waterbase[]" id="waterbase" value="Scuba Diving (licence required)"/>Scuba Diving (licence required)
							...
							<input type="checkbox" name="waterbase[]" id="waterbase" value="Snorkelling"/>Snorkelling
							...
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
							</select> <input type="checkbox" name="waterbase[]" id="waterbase" value="Jet Skiing"/>
							Jet Skiing <br />
							<br />
							...
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
							</select> <input type="checkbox" name="waterbase[]" id="waterbase" value="Total days at the beach (with or without activities)"/>Total days at the beach (with or without activities)							</td>
                            </tr>
                          <tr>
                            <td align="left" valign="middle">&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">Special Courses for learners:</td>
                            <td align="left" valign="middle"><select name="scubalearn" id="scubalearn" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
							</select> <input type="checkbox" name="courses[]" id="courses" value="Scuba Diving (min. 5 days)"/>Scuba Diving (min. 5 days)<br />
							<br /><select name="surflearn" id="surflearn" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
							</select> <input type="checkbox" name="courses[]" id="courses" value="Surfing"/>Surfing</td>
                          </tr>
                          <!--<tr>
                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="16%" align="left" valign="middle">Archaeological sites :</td>
                          <td width="84%" height="35" align="left" valign="middle"><input type="checkbox" name="archaeo[]" id="archaeo" value="Anuradhapura"/>Anuradhapura
                        ...
                        <tr>
                          ...
                          <td height="35" align="left" valign="middle"><select name="treatdays" id="treatdays" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
							...
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
							</select> <input type="checkbox" name="wellness[]" id="wellness" value="Ayurveda massage"/>Ayurveda massage</td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle">&nbsp;</td>
                          <td height="19" align="left" valign="middle">&nbsp;</td>
                        ...
                        <tr>
                          ...
                          <td height="35" align="left" valign="middle"><input type="checkbox" name="speplaces[]" id="speplaces" value="Tea Plantations"/>Tea Plantations
							<input type="checkbox" name="speplaces[]" id="speplaces" value="Diamond Mine"/>Diamond Mine</td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle">&nbsp;</td>
                          <td height="19" align="left" valign="middle">&nbsp;</td>
                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="16%" height="30" align="left" valign="middle" class="txt">Day 1 : </td>
                          <td width="34%" align="left" valign="middle"><select name="day1count" id="day1count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                          ...
                          <td width="18%" align="left" valign="middle">Day 2 :</td>
                          <td width="32%" align="left" valign="middle"><select name="day2count" id="day2count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                        ...
                        <tr>
                          <td height="30" align="left" valign="middle" class="txt">Day 3 :                            </td>
                          <td align="left" valign="middle"><select name="day3count" id="day3count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                          ...
                          <td align="left" valign="middle"><select name="day4count" id="day4count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                        ...
                        <tr>
                          <td height="30" align="left" valign="middle" class="txt">Day 5 :</td>
                          <td align="left" valign="middle"><select name="day5count" id="day5count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                          ...
                          <td align="left" valign="middle"><select name="day6count" id="day6count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                        ...
                        <tr>
                          <td height="30" align="left" valign="middle" class="txt">Day 7 :</td>
                          <td align="left" valign="middle"><select name="day7count" id="day7count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                          ...
                          <td align="left" valign="middle"><select name="day8count" id="day8count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                        ...
                        <tr>
                          <td height="30" align="left" valign="middle" class="txt">Day 9 : </td>
                          <td align="left" valign="middle"><select name="day9count" id="day9count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                          ...
                          <td align="left" valign="middle"><select name="day10count" id="day10count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                        ...
                        <tr>
                          <td height="30" align="left" valign="middle" class="txt">Day 11 : </td>
                          <td align="left" valign="middle"><select name="day11count" id="day11count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                          ...
                          <td align="left" valign="middle"><select name="day12count" id="day12count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                        ...
                        <tr>
                          <td height="30" align="left" valign="middle" class="txt">Day 13 : </td>
                          <td align="left" valign="middle"><select name="day13count" id="day13count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                          ...
                          <td align="left" valign="middle"><select name="day14count" id="day14count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                        ...
                        <tr>
                          <td height="30" align="left" valign="middle" class="txt">Day 15 : </td>
                          <td align="left" valign="middle"><select name="day15count" id="day15count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                          ...
                          <td align="left" valign="middle"><select name="day16count" id="day16count" class="input" size:width="200" >
							<option value=''>- select -</option>
							<?php for($w=1; $w < 16; $w++) { ?>
							<option value='<?php echo $w; ?>'><?php echo $w; ?></option>
							<?php } ?>
                    ...
                    <tr>
                      <td align="left" valign="top"><textarea name="foodall" id="foodall" cols="70" class="textarea"></textarea></td>
                    </tr>
                    <tr>
